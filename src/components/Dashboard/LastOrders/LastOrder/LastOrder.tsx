...
const LastOrder: React.FC<any> = ({ order }: LastOrderProps) => {
  return (
    <div className="bg-white text-center px-3 md:px-10 py-3 rounded-xl flex justify-between items-center flex-wrap flex-row flex-1 hover:scale-105 ease-in duration-300">
