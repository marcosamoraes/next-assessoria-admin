...
export default function ToggleButton({ name, defaultChecked, value }: ToggleButtonProps) {
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      <input type="checkbox" value={value} name={name} className="sr-only peer" defaultChecked={defaultChecked} />
      <div
